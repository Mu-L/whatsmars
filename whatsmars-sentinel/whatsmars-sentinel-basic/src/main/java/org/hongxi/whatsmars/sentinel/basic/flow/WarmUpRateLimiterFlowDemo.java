...
/**
 * When {@link FlowRule#getControlBehavior()} set to {@link RuleConstant#CONTROL_BEHAVIOR_WARM_UP_RATE_LIMITER}, real passed
 * qps will gradually increase to {@link FlowRule#getCount()}, other than burst increasing, and after the passed qps reaches
 ...
 * 1541035861113, total:2909, pass:20, block:2889 // warm up process end, pass qps increased to {@link FlowRule#getCount()}
