package org.hongxi.whatsmars.grpc.client.healthservice;
...
/**
 * A client that requests a greeting from the HelloWorldServer.
 */
public class HealthServiceClient {
    ...
    private ServingStatus checkHealth(String prefix) {
        ...
        logger.info("{}, current health is: {}", prefix, response.getStatus());
