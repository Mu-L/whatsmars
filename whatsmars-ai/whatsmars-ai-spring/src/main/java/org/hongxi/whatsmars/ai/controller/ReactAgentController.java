...
public class ReactAgentController {
    ...
    public String handleComplexTask(@RequestParam String message) {
        ...
        String response = chatClient.prompt()
                .system("""
                        ...
                        可用的工具：天气查询、时间查询、知识搜索、最新资讯、数学计算
    ...
    public String demo() {
        ...
        return """
                === 天气查询 ===
                问: 北京今天的天气怎么样？我需要出门，应该穿什么衣服？
                答: %s
                
                === 知识搜索 ===
                问: 什么是 Apache Dubbo？它有什么特点？
                答: %s
                
                === 数学计算 ===
                问: 如果一个商品原价 299 元，打 8 折后再减 50 元优惠券，最终价格是多少？
                答: %s
                
                === 综合查询 ===
                问: 我想了解微服务架构的最新发展趋势，以及 Spring Boot 在其中的作用
                答: %s
                """.formatted(weatherAnswer, searchAnswer, calcAnswer, complexAnswer);
    }
}
